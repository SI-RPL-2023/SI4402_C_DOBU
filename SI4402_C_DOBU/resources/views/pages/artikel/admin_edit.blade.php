    ...
    <div class="row">
        <div class="col-md-8 offset-md-2 mt-2">
            ...
            <h3 class="text-blue font-weight-bold mt-5 mb-5">
                ...
                Edit {{ $data->name_artikel }}
            </h3>
            <form action="{{ url("/_artikel/$data->id_artikel") }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group mb-3">
                    <label for="name_artikel" class="text-title1 text-blue">Nama Acara</label>
                    <input type="text"
                           class="form-control mt-1 text-title1 text-blue @error('name_artikel') is-invalid @enderror"
                           id="name_artikel" name="name_artikel"
                           placeholder="Nama Acara" required value="{{ $data->name_artikel  }}">
                    @error('name_artikel')
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea
                        ...
                        rows="3">{{ $data->desc_artikel }}</textarea>
                    @error('desc_artikel')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="form-group mb-3 d-flex flex-column">
                    ...
                    <img id="output" src="{{ $data->thumbnail_artikel }}" class="img-fluid w-25">
