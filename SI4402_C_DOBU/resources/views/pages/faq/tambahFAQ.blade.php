        ...
        <div class="col-md-8 offset-md-2 mt-2">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    <label for="name_donor_events" class="text-title1 text-blue">Nama FAQ</label>
                    <input type="text"
                    ...
                    placeholder="Masukan nama faq" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea
                        ...
                        rows="3" placeholder="isi jawaban dari FAQ" required></textarea>
